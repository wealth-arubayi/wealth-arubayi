...
side, I build medallion-architecture pipelines (Bronze → Silver → Gold) with 
dimensional modeling that's ready for both dashboards and auditors.
...
- 🤔 I'm looking for help with: nothing specific right now, but always open to a 
  conversation on Databricks or reporting architecture
